...
#line 29 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtSql/sipQtSqlQSqlRelation.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtSql/sipQtSqlQSqlRelation.cpp"
...
extern "C" {static void *array_QSqlRelation(Py_ssize_t);}
static void *array_QSqlRelation(Py_ssize_t sipNrElem)
{
    return new  ::QSqlRelation[sipNrElem];
}


extern "C" {static void assign_QSqlRelation(void *, Py_ssize_t, void *);}
static void assign_QSqlRelation(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QSqlRelation *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QSqlRelation *>(sipSrc);
}


extern "C" {static void *copy_QSqlRelation(const void *, Py_ssize_t);}
static void *copy_QSqlRelation(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
{
     ::QSqlRelation *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_QSqlRelation, &a0))
        {
...
static PyMethodDef methods_QSqlRelation[] = {
    {sipName_displayColumn, meth_QSqlRelation_displayColumn, METH_VARARGS, doc_QSqlRelation_displayColumn},
    {sipName_indexColumn, meth_QSqlRelation_indexColumn, METH_VARARGS, doc_QSqlRelation_indexColumn},
    {sipName_isValid, meth_QSqlRelation_isValid, METH_VARARGS, doc_QSqlRelation_isValid},
    {sipName_swap, meth_QSqlRelation_swap, METH_VARARGS, doc_QSqlRelation_swap},
    {sipName_tableName, meth_QSqlRelation_tableName, METH_VARARGS, doc_QSqlRelation_tableName}
};
