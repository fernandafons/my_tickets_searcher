...
#include <qpalette.h>
#line 29 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtGui/sipQtGuiQPalette.cpp"

#line 26 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/sip/QtGui/qcolor.sip"
#include <qcolor.h>
#line 33 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtGui/sipQtGuiQPalette.cpp"
#line 26 "sip/QtCore/qnamespace.sip"
#include <qnamespace.h>
#line 36 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtGui/sipQtGuiQPalette.cpp"
#line 26 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/sip/QtGui/qbrush.sip"
#include <qbrush.h>
#line 39 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtGui/sipQtGuiQPalette.cpp"
#line 26 "sip/QtCore/qvariant.sip"
#include <qvariant.h>
#line 42 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtGui/sipQtGuiQPalette.cpp"
...
extern "C" {static void *array_QPalette(Py_ssize_t);}
static void *array_QPalette(Py_ssize_t sipNrElem)
{
    return new  ::QPalette[sipNrElem];
}


extern "C" {static void assign_QPalette(void *, Py_ssize_t, void *);}
static void assign_QPalette(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QPalette *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QPalette *>(sipSrc);
}


extern "C" {static void *copy_QPalette(const void *, Py_ssize_t);}
static void *copy_QPalette(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
#line 38 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/sip/QtGui/qpalette.sip"
        if (a0->canConvert<QPalette>())
            sipCpp = new QPalette(a0->value<QPalette>());
        else
            sipError = sipBadCallableArg(0, a0Wrapper);
#line 1298 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtGui/sipQtGuiQPalette.cpp"
...
static PyMethodDef methods_QPalette[] = {
    {sipName_alternateBase, meth_QPalette_alternateBase, METH_VARARGS, doc_QPalette_alternateBase},
    {sipName_base, meth_QPalette_base, METH_VARARGS, doc_QPalette_base},
    {sipName_brightText, meth_QPalette_brightText, METH_VARARGS, doc_QPalette_brightText},
    {sipName_brush, meth_QPalette_brush, METH_VARARGS, doc_QPalette_brush},
    {sipName_button, meth_QPalette_button, METH_VARARGS, doc_QPalette_button},
    {sipName_buttonText, meth_QPalette_buttonText, METH_VARARGS, doc_QPalette_buttonText},
    {sipName_cacheKey, meth_QPalette_cacheKey, METH_VARARGS, doc_QPalette_cacheKey},
    {sipName_color, meth_QPalette_color, METH_VARARGS, doc_QPalette_color},
    {sipName_currentColorGroup, meth_QPalette_currentColorGroup, METH_VARARGS, doc_QPalette_currentColorGroup},
    {sipName_dark, meth_QPalette_dark, METH_VARARGS, doc_QPalette_dark},
    {sipName_highlight, meth_QPalette_highlight, METH_VARARGS, doc_QPalette_highlight},
    {sipName_highlightedText, meth_QPalette_highlightedText, METH_VARARGS, doc_QPalette_highlightedText},
    {sipName_isBrushSet, meth_QPalette_isBrushSet, METH_VARARGS, doc_QPalette_isBrushSet},
    {sipName_isCopyOf, meth_QPalette_isCopyOf, METH_VARARGS, doc_QPalette_isCopyOf},
    {sipName_isEqual, meth_QPalette_isEqual, METH_VARARGS, doc_QPalette_isEqual},
    {sipName_light, meth_QPalette_light, METH_VARARGS, doc_QPalette_light},
    {sipName_link, meth_QPalette_link, METH_VARARGS, doc_QPalette_link},
    {sipName_linkVisited, meth_QPalette_linkVisited, METH_VARARGS, doc_QPalette_linkVisited},
    {sipName_mid, meth_QPalette_mid, METH_VARARGS, doc_QPalette_mid},
    {sipName_midlight, meth_QPalette_midlight, METH_VARARGS, doc_QPalette_midlight},
    {sipName_placeholderText, meth_QPalette_placeholderText, METH_VARARGS, doc_QPalette_placeholderText},
    {sipName_resolve, meth_QPalette_resolve, METH_VARARGS, doc_QPalette_resolve},
    {sipName_setBrush, meth_QPalette_setBrush, METH_VARARGS, doc_QPalette_setBrush},
    {sipName_setColor, meth_QPalette_setColor, METH_VARARGS, doc_QPalette_setColor},
    {sipName_setColorGroup, meth_QPalette_setColorGroup, METH_VARARGS, doc_QPalette_setColorGroup},
    {sipName_setCurrentColorGroup, meth_QPalette_setCurrentColorGroup, METH_VARARGS, doc_QPalette_setCurrentColorGroup},
    {sipName_shadow, meth_QPalette_shadow, METH_VARARGS, doc_QPalette_shadow},
    {sipName_swap, meth_QPalette_swap, METH_VARARGS, doc_QPalette_swap},
    {sipName_text, meth_QPalette_text, METH_VARARGS, doc_QPalette_text},
    {sipName_toolTipBase, meth_QPalette_toolTipBase, METH_VARARGS, doc_QPalette_toolTipBase},
    {sipName_toolTipText, meth_QPalette_toolTipText, METH_VARARGS, doc_QPalette_toolTipText},
    {sipName_window, meth_QPalette_window, METH_VARARGS, doc_QPalette_window},
    {sipName_windowText, meth_QPalette_windowText, METH_VARARGS, doc_QPalette_windowText}
};

static sipEnumMemberDef enummembers_QPalette[] = {
    {sipName_Active, static_cast<int>( ::QPalette::Active), 219},
    {sipName_All, static_cast<int>( ::QPalette::All), 219},
    {sipName_AlternateBase, static_cast<int>( ::QPalette::AlternateBase), 220},
    {sipName_Background, static_cast<int>( ::QPalette::Background), 220},
    {sipName_Base, static_cast<int>( ::QPalette::Base), 220},
    {sipName_BrightText, static_cast<int>( ::QPalette::BrightText), 220},
    {sipName_Button, static_cast<int>( ::QPalette::Button), 220},
    {sipName_ButtonText, static_cast<int>( ::QPalette::ButtonText), 220},
    {sipName_Current, static_cast<int>( ::QPalette::Current), 219},
    {sipName_Dark, static_cast<int>( ::QPalette::Dark), 220},
    {sipName_Disabled, static_cast<int>( ::QPalette::Disabled), 219},
    {sipName_Foreground, static_cast<int>( ::QPalette::Foreground), 220},
    {sipName_Highlight, static_cast<int>( ::QPalette::Highlight), 220},
    {sipName_HighlightedText, static_cast<int>( ::QPalette::HighlightedText), 220},
    {sipName_Inactive, static_cast<int>( ::QPalette::Inactive), 219},
    {sipName_Light, static_cast<int>( ::QPalette::Light), 220},
    {sipName_Link, static_cast<int>( ::QPalette::Link), 220},
    {sipName_LinkVisited, static_cast<int>( ::QPalette::LinkVisited), 220},
    {sipName_Mid, static_cast<int>( ::QPalette::Mid), 220},
    {sipName_Midlight, static_cast<int>( ::QPalette::Midlight), 220},
    {sipName_NColorGroups, static_cast<int>( ::QPalette::NColorGroups), 219},
    {sipName_NColorRoles, static_cast<int>( ::QPalette::NColorRoles), 220},
    {sipName_NoRole, static_cast<int>( ::QPalette::NoRole), 220},
    {sipName_Normal, static_cast<int>( ::QPalette::Normal), 219},
    {sipName_PlaceholderText, static_cast<int>( ::QPalette::PlaceholderText), 220},
    {sipName_Shadow, static_cast<int>( ::QPalette::Shadow), 220},
    {sipName_Text, static_cast<int>( ::QPalette::Text), 220},
    {sipName_ToolTipBase, static_cast<int>( ::QPalette::ToolTipBase), 220},
    {sipName_ToolTipText, static_cast<int>( ::QPalette::ToolTipText), 220},
    {sipName_Window, static_cast<int>( ::QPalette::Window), 220},
    {sipName_WindowText, static_cast<int>( ::QPalette::WindowText), 220},
};
