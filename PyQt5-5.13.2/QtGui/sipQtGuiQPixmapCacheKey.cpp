...
#include <qpixmapcache.h>
#line 31 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtGui/sipQtGuiQPixmapCacheKey.cpp"
...
extern "C" {static void *array_QPixmapCache_Key(Py_ssize_t);}
static void *array_QPixmapCache_Key(Py_ssize_t sipNrElem)
{
    return new  ::QPixmapCache::Key[sipNrElem];
}


extern "C" {static void assign_QPixmapCache_Key(void *, Py_ssize_t, void *);}
static void assign_QPixmapCache_Key(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QPixmapCache::Key *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QPixmapCache::Key *>(sipSrc);
}


extern "C" {static void *copy_QPixmapCache_Key(const void *, Py_ssize_t);}
static void *copy_QPixmapCache_Key(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
static PyMethodDef methods_QPixmapCache_Key[] = {
    {sipName_isValid, meth_QPixmapCache_Key_isValid, METH_VARARGS, doc_QPixmapCache_Key_isValid},
    {sipName_swap, meth_QPixmapCache_Key_swap, METH_VARARGS, doc_QPixmapCache_Key_swap}
};
