...
#include <qxml.h>
#line 29 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtXml/sipQtXmlQXmlInputSource.cpp"

#line 26 "sip/QtCore/qiodevice.sip"
#include <qiodevice.h>
#line 33 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtXml/sipQtXmlQXmlInputSource.cpp"
#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 36 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtXml/sipQtXmlQXmlInputSource.cpp"
#line 30 "sip/QtCore/qbytearray.sip"
#include <qbytearray.h>
#line 39 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtXml/sipQtXmlQXmlInputSource.cpp"
#line 27 "sip/QtCore/qchar.sip"
#include <qchar.h>
#line 42 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtXml/sipQtXmlQXmlInputSource.cpp"
...
public:
     ...
     */
protected:
     ::QString fromRawData(const  ::QByteArray&,bool) SIP_OVERRIDE;
    void reset() SIP_OVERRIDE;
     ::QChar next() SIP_OVERRIDE;
     ::QString data() const SIP_OVERRIDE;
    void fetchData() SIP_OVERRIDE;
    void setData(const  ::QByteArray&) SIP_OVERRIDE;
    void setData(const  ::QString&) SIP_OVERRIDE;
...
sipQXmlInputSource::sipQXmlInputSource():  ::QXmlInputSource(), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipQXmlInputSource::sipQXmlInputSource( ::QIODevice*a0):  ::QXmlInputSource(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipQXmlInputSource::sipQXmlInputSource(const  ::QXmlInputSource& a0):  ::QXmlInputSource(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
 ...
 ::QString sipQXmlInputSource::fromRawData(const  ::QByteArray& a0,bool a1)
{
    ...
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[0], &sipPySelf, SIP_NULLPTR, sipName_fromRawData);

#else
    sipMeth = sipIsPyMethod(&sipGILState, &sipPyMethods[0], sipPySelf, SIP_NULLPTR, sipName_fromRawData);
#endif
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[1], &sipPySelf, SIP_NULLPTR, sipName_reset);
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[2], &sipPySelf, SIP_NULLPTR, sipName_next);

#else
    sipMeth = sipIsPyMethod(&sipGILState, &sipPyMethods[2], sipPySelf, SIP_NULLPTR, sipName_next);
#endif
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, const_cast<char *>(&sipPyMethods[3]), const_cast<sipSimpleWrapper **>(&sipPySelf), SIP_NULLPTR, sipName_data);

#else
    sipMeth = sipIsPyMethod(&sipGILState, const_cast<char *>(&sipPyMethods[3]), sipPySelf, SIP_NULLPTR, sipName_data);
#endif
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[4], &sipPySelf, SIP_NULLPTR, sipName_fetchData);

#else
    sipMeth = sipIsPyMethod(&sipGILState, &sipPyMethods[4], sipPySelf, SIP_NULLPTR, sipName_fetchData);
#endif
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[6], &sipPySelf, SIP_NULLPTR, sipName_setData);
...
static PyObject *meth_QXmlInputSource_fromRawData(PyObject *sipSelf, PyObject *sipArgs, PyObject *sipKwds)
{
...

    {
        ...
        if (sipParseKwdArgs(&sipParseErr, sipArgs, sipKwds, sipKwdList, SIP_NULLPTR, "pJ1|b", &sipSelf, sipType_QXmlInputSource, &sipCpp, sipType_QByteArray, &a0, &a0State, &a1))
        {
             ::QString*sipRes;
...
extern "C" {static void *array_QXmlInputSource(Py_ssize_t);}
static void *array_QXmlInputSource(Py_ssize_t sipNrElem)
{
    return new  ::QXmlInputSource[sipNrElem];
}


extern "C" {static void assign_QXmlInputSource(void *, Py_ssize_t, void *);}
static void assign_QXmlInputSource(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QXmlInputSource *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QXmlInputSource *>(sipSrc);
}


extern "C" {static void *copy_QXmlInputSource(const void *, Py_ssize_t);}
static void *copy_QXmlInputSource(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
static void dealloc_QXmlInputSource(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipQXmlInputSource *>(sipGetAddress(sipSelf))->sipPySelf = SIP_NULLPTR;
...
{
    sipQXmlInputSource *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_QXmlInputSource, &a0))
        {
            sipCpp = new sipQXmlInputSource(*a0);
...
static PyMethodDef methods_QXmlInputSource[] = {
    {sipName_data, meth_QXmlInputSource_data, METH_VARARGS, doc_QXmlInputSource_data},
    {sipName_fetchData, meth_QXmlInputSource_fetchData, METH_VARARGS, doc_QXmlInputSource_fetchData},
    {sipName_fromRawData, SIP_MLMETH_CAST(meth_QXmlInputSource_fromRawData), METH_VARARGS|METH_KEYWORDS, doc_QXmlInputSource_fromRawData},
    {sipName_next, meth_QXmlInputSource_next, METH_VARARGS, doc_QXmlInputSource_next},
    {sipName_reset, meth_QXmlInputSource_reset, METH_VARARGS, doc_QXmlInputSource_reset},
    {sipName_setData, meth_QXmlInputSource_setData, METH_VARARGS, doc_QXmlInputSource_setData}
};
...
sipVariableDef variables_QXmlInputSource[] = {
    {ClassVariable, sipName_EndOfData, (PyMethodDef *)varget_QXmlInputSource_EndOfData, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
    {ClassVariable, sipName_EndOfDocument, (PyMethodDef *)varget_QXmlInputSource_EndOfDocument, SIP_NULLPTR, SIP_NULLPTR, SIP_NULLPTR},
};
