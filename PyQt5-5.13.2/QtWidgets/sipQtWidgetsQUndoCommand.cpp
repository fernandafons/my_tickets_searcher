...
#line 29 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQUndoCommand.cpp"

#line 27 "sip/QtCore/qstring.sip"
#include <qstring.h>
#line 33 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQUndoCommand.cpp"
...
protected:
    ...
    bool mergeWith(const  ::QUndoCommand*) SIP_OVERRIDE;
    int id() const SIP_OVERRIDE;
...
sipQUndoCommand::sipQUndoCommand( ::QUndoCommand*a0):  ::QUndoCommand(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipQUndoCommand::sipQUndoCommand(const  ::QString& a0, ::QUndoCommand*a1):  ::QUndoCommand(a0,a1), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
void sipQUndoCommand::undo()
{
    ...
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[0], &sipPySelf, SIP_NULLPTR, sipName_undo);
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[1], &sipPySelf, SIP_NULLPTR, sipName_redo);

#else
    sipMeth = sipIsPyMethod(&sipGILState, &sipPyMethods[1], sipPySelf, SIP_NULLPTR, sipName_redo);
#endif
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[2], &sipPySelf, SIP_NULLPTR, sipName_mergeWith);

#else
    sipMeth = sipIsPyMethod(&sipGILState, &sipPyMethods[2], sipPySelf, SIP_NULLPTR, sipName_mergeWith);
#endif
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, const_cast<char *>(&sipPyMethods[3]), const_cast<sipSimpleWrapper **>(&sipPySelf), SIP_NULLPTR, sipName_id);

#else
    sipMeth = sipIsPyMethod(&sipGILState, const_cast<char *>(&sipPyMethods[3]), sipPySelf, SIP_NULLPTR, sipName_id);
#endif
...
extern "C" {static void *array_QUndoCommand(Py_ssize_t);}
static void *array_QUndoCommand(Py_ssize_t sipNrElem)
{
    return new  ::QUndoCommand[sipNrElem];
}
...
static void dealloc_QUndoCommand(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipQUndoCommand *>(sipGetAddress(sipSelf))->sipPySelf = SIP_NULLPTR;
...
{
    sipQUndoCommand *sipCpp = SIP_NULLPTR;
...
static PyMethodDef methods_QUndoCommand[] = {
    {sipName_actionText, meth_QUndoCommand_actionText, METH_VARARGS, doc_QUndoCommand_actionText},
    {sipName_child, meth_QUndoCommand_child, METH_VARARGS, doc_QUndoCommand_child},
    {sipName_childCount, meth_QUndoCommand_childCount, METH_VARARGS, doc_QUndoCommand_childCount},
    {sipName_id, meth_QUndoCommand_id, METH_VARARGS, doc_QUndoCommand_id},
    {sipName_isObsolete, meth_QUndoCommand_isObsolete, METH_VARARGS, doc_QUndoCommand_isObsolete},
    {sipName_mergeWith, meth_QUndoCommand_mergeWith, METH_VARARGS, doc_QUndoCommand_mergeWith},
    {sipName_redo, meth_QUndoCommand_redo, METH_VARARGS, doc_QUndoCommand_redo},
    {sipName_setObsolete, meth_QUndoCommand_setObsolete, METH_VARARGS, doc_QUndoCommand_setObsolete},
    {sipName_setText, meth_QUndoCommand_setText, METH_VARARGS, doc_QUndoCommand_setText},
    {sipName_text, meth_QUndoCommand_text, METH_VARARGS, doc_QUndoCommand_text},
    {sipName_undo, meth_QUndoCommand_undo, METH_VARARGS, doc_QUndoCommand_undo}
};
