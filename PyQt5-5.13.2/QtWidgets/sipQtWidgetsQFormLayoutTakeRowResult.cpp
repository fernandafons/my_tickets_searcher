...
#include <qformlayout.h>
#line 31 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQFormLayoutTakeRowResult.cpp"

#line 26 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/sip/QtWidgets/qlayoutitem.sip"
#include <qlayoutitem.h>
#line 35 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQFormLayoutTakeRowResult.cpp"
...
extern "C" {static void *array_QFormLayout_TakeRowResult(Py_ssize_t);}
static void *array_QFormLayout_TakeRowResult(Py_ssize_t sipNrElem)
{
    return new  ::QFormLayout::TakeRowResult[sipNrElem];
}


extern "C" {static void assign_QFormLayout_TakeRowResult(void *, Py_ssize_t, void *);}
static void assign_QFormLayout_TakeRowResult(void *sipDst, Py_ssize_t sipDstIdx, void *sipSrc)
{
    reinterpret_cast< ::QFormLayout::TakeRowResult *>(sipDst)[sipDstIdx] = *reinterpret_cast< ::QFormLayout::TakeRowResult *>(sipSrc);
}


extern "C" {static void *copy_QFormLayout_TakeRowResult(const void *, Py_ssize_t);}
static void *copy_QFormLayout_TakeRowResult(const void *sipSrc, Py_ssize_t sipSrcIdx)
{
...
{
     ::QFormLayout::TakeRowResult *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_QFormLayout_TakeRowResult, &a0))
        {
...
static PyObject *varget_QFormLayout_TakeRowResult_fieldItem(void *sipSelf, PyObject *, PyObject *)
{
    ...
    return sipConvertFromType(sipVal, sipType_QLayoutItem, SIP_NULLPTR);
}
...
static int varset_QFormLayout_TakeRowResult_fieldItem(void *sipSelf, PyObject *sipPy, PyObject *)
{
    ...
    sipVal = reinterpret_cast< ::QLayoutItem *>(sipForceConvertToType(sipPy, sipType_QLayoutItem, SIP_NULLPTR, 0, SIP_NULLPTR, &sipIsErr));
...
sipVariableDef variables_QFormLayout_TakeRowResult[] = {
    {InstanceVariable, sipName_fieldItem, (PyMethodDef *)varget_QFormLayout_TakeRowResult_fieldItem, (PyMethodDef *)varset_QFormLayout_TakeRowResult_fieldItem, SIP_NULLPTR, SIP_NULLPTR},
    {InstanceVariable, sipName_labelItem, (PyMethodDef *)varget_QFormLayout_TakeRowResult_labelItem, (PyMethodDef *)varset_QFormLayout_TakeRowResult_labelItem, SIP_NULLPTR, SIP_NULLPTR},
};
