...
#line 29 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQGestureRecognizer.cpp"

#line 26 "sip/QtCore/qnamespace.sip"
#include <qnamespace.h>
#line 33 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQGestureRecognizer.cpp"
#line 26 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/sip/QtWidgets/qgesture.sip"
#include <qgesture.h>
#line 36 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQGestureRecognizer.cpp"
#line 26 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/sip/QtWidgets/qgesturerecognizer.sip"
#include <qgesturerecognizer.h>
#line 39 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQGestureRecognizer.cpp"
#line 28 "sip/QtCore/qobject.sip"
#include <qobject.h>
#line 42 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQGestureRecognizer.cpp"
#line 26 "sip/QtCore/qcoreevent.sip"
#include <qcoreevent.h>
#line 45 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQGestureRecognizer.cpp"
...
public:
     ...
     */
protected:
    void reset( ::QGesture*) SIP_OVERRIDE;
     ::QGestureRecognizer::Result recognize( ::QGesture*, ::QObject*, ::QEvent*) SIP_OVERRIDE;
     ::QGesture* create( ::QObject*) SIP_OVERRIDE;
...
sipQGestureRecognizer::sipQGestureRecognizer():  ::QGestureRecognizer(), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipQGestureRecognizer::sipQGestureRecognizer(const  ::QGestureRecognizer& a0):  ::QGestureRecognizer(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
...
void sipQGestureRecognizer::reset( ::QGesture*a0)
{
    ...
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[0], &sipPySelf, SIP_NULLPTR, sipName_reset);
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[1], &sipPySelf, sipName_QGestureRecognizer, sipName_recognize);
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, &sipPyMethods[2], &sipPySelf, SIP_NULLPTR, sipName_create);
...
static PyObject *meth_QGestureRecognizer_create(PyObject *sipSelf, PyObject *sipArgs)
{
...

    {
        ...
        if (sipParseArgs(&sipParseErr, sipArgs, "BJ8", &sipSelf, sipType_QGestureRecognizer, &sipCpp, sipType_QObject, &a0))
        {
            ...
            return sipConvertFromNewType(sipRes,sipType_QGesture,SIP_NULLPTR);
        }
    }
...
static void dealloc_QGestureRecognizer(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipQGestureRecognizer *>(sipGetAddress(sipSelf))->sipPySelf = SIP_NULLPTR;
...
{
    sipQGestureRecognizer *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_QGestureRecognizer, &a0))
        {
...
static PyMethodDef methods_QGestureRecognizer[] = {
    {sipName_create, meth_QGestureRecognizer_create, METH_VARARGS, doc_QGestureRecognizer_create},
    {sipName_recognize, meth_QGestureRecognizer_recognize, METH_VARARGS, doc_QGestureRecognizer_recognize},
    {sipName_registerRecognizer, meth_QGestureRecognizer_registerRecognizer, METH_VARARGS, doc_QGestureRecognizer_registerRecognizer},
    {sipName_reset, meth_QGestureRecognizer_reset, METH_VARARGS, doc_QGestureRecognizer_reset},
    {sipName_unregisterRecognizer, meth_QGestureRecognizer_unregisterRecognizer, METH_VARARGS, doc_QGestureRecognizer_unregisterRecognizer}
};

static sipEnumMemberDef enummembers_QGestureRecognizer[] = {
    {sipName_CancelGesture, static_cast<int>( ::QGestureRecognizer::CancelGesture), 109},
    {sipName_ConsumeEventHint, static_cast<int>( ::QGestureRecognizer::ConsumeEventHint), 109},
    {sipName_FinishGesture, static_cast<int>( ::QGestureRecognizer::FinishGesture), 109},
    {sipName_Ignore, static_cast<int>( ::QGestureRecognizer::Ignore), 109},
    {sipName_MayBeGesture, static_cast<int>( ::QGestureRecognizer::MayBeGesture), 109},
    {sipName_TriggerGesture, static_cast<int>( ::QGestureRecognizer::TriggerGesture), 109},
};
