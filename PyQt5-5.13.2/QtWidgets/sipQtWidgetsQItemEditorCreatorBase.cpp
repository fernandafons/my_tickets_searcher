...
#line 29 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQItemEditorCreatorBase.cpp"

#line 30 "sip/QtCore/qbytearray.sip"
#include <qbytearray.h>
#line 33 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQItemEditorCreatorBase.cpp"
#line 28 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/sip/QtWidgets/qwidget.sip"
#include <qwidget.h>
#line 36 "/home/fernandaabreu/projetos/MyTicketsSearcher/PyQt5-5.13.2/QtWidgets/sipQtWidgetsQItemEditorCreatorBase.cpp"
...
public:
     ...
     */
protected:
     ::QByteArray valuePropertyName() const SIP_OVERRIDE;
     ::QWidget* createWidget( ::QWidget*) const SIP_OVERRIDE;
...
sipQItemEditorCreatorBase::sipQItemEditorCreatorBase():  ::QItemEditorCreatorBase(), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}

sipQItemEditorCreatorBase::sipQItemEditorCreatorBase(const  ::QItemEditorCreatorBase& a0):  ::QItemEditorCreatorBase(a0), sipPySelf(SIP_NULLPTR)
{
    memset(sipPyMethods, 0, sizeof (sipPyMethods));
}
 ...
 ::QByteArray sipQItemEditorCreatorBase::valuePropertyName() const
{
    ...
    sipMeth = sipIsPyMethod_12_8(&sipGILState, const_cast<char *>(&sipPyMethods[0]), const_cast<sipSimpleWrapper **>(&sipPySelf), sipName_QItemEditorCreatorBase, sipName_valuePropertyName);
...
#if SIP_ABI_MAJOR_VERSION >= 12 && SIP_ABI_MINOR_VERSION >= 8
    sipMeth = sipIsPyMethod_12_8(&sipGILState, const_cast<char *>(&sipPyMethods[1]), const_cast<sipSimpleWrapper **>(&sipPySelf), sipName_QItemEditorCreatorBase, sipName_createWidget);
...
static void dealloc_QItemEditorCreatorBase(sipSimpleWrapper *sipSelf)
{
    if (sipIsDerivedClass(sipSelf))
        reinterpret_cast<sipQItemEditorCreatorBase *>(sipGetAddress(sipSelf))->sipPySelf = SIP_NULLPTR;
...
{
    sipQItemEditorCreatorBase *sipCpp = SIP_NULLPTR;
...

    {
        ...
        if (sipParseKwdArgs(sipParseErr, sipArgs, sipKwds, SIP_NULLPTR, sipUnused, "J9", sipType_QItemEditorCreatorBase, &a0))
        {
...
static PyMethodDef methods_QItemEditorCreatorBase[] = {
    {sipName_createWidget, meth_QItemEditorCreatorBase_createWidget, METH_VARARGS, doc_QItemEditorCreatorBase_createWidget},
    {sipName_valuePropertyName, meth_QItemEditorCreatorBase_valuePropertyName, METH_VARARGS, doc_QItemEditorCreatorBase_valuePropertyName}
};
