...
{
    // Enable overflow checking on int conversions.
...
#if PY_MAJOR_VERSION >= 3
    PyObject *sip_flags = PyUnicode_FromString("-n PyQt5.sip -t WS_X11 -t Qt_5_12_4 -x PyQt_WebChannel");
#else
    PyObject *sip_flags = PyString_FromString("-n PyQt5.sip -t WS_X11 -t Qt_5_12_4 -x PyQt_WebChannel");
#endif
